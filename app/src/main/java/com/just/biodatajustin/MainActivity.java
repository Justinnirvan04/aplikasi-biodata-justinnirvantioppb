package com.just.biodatajustin;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickCallsEvent (View view){
        Intent intent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel: 087732623701"));
    ...
    public void maps (View view) {
        Uri uri = Uri.parse("geo:-6.520467, 111.036261");
    ...
    public void email (View view){
        ...
        intent.putExtra(Intent.EXTRA_EMAIL, new String[]{"111202113426@mhs.dinus.ac.id"});
